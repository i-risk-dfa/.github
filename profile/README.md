# Informatics for Multi-hazard Risk Reduction (i-Risk) Doctoral Focal Award


i-Risk is a NERC funded Doctoral Focal Award training 41+ PhD researchers to become the next generation of global leaders in transformative, interdisciplinary informatics for disaster risk reduction (DRR), which can exploit these nascent technologies to increase understanding of evolving, and multiple, natural hazards under climate change and urbanisation – and their escalating impacts on society and infrastructure – to enhance resilience.
...
The i-Risk training program has 3 strands: 
- Cohort training
- PhD Research
...
**Integrated cohort training** and regular partner interaction will help students build networks and relationships beyond supervisors, exposing them to a wide range of environments, motivations/ideas and, importantly, develop the partner-identified skills.  The core components of the annual cohort training programme include: 
  ...
  2) Hackathon (Jan/Feb) for students to explore software-based solutions to partner-set challenges, aiming to develop teamwork and leadership skills;
  3) Summer conference (Jul/Aug) – students will participate in annual LU’s UNESCO Chair Conferences and attend regular UNESCO Chairs’ training courses with world leading DRR experts; and
  4) Digital capacity (linear) – online digital cohort training will be coordinated via Slack and a CDT GitHub group for students to study research software engineering, AI ethics, documentation, FAIR principles, etc., participate in best practice activities (e.g. code club, journal club) and online seminars, and manage the online community, encouraging them to develop good practice early on.
  5) 

**PhD research** Supervisors (2 academics at different career stages, 1 partner representative) will ensure projects to focus on one or more of the four i-Risk research themes to address real-world challenges, deliver high-quality, cutting-edge research, and enable students to develop the skills that set them apart: adaptability, i.e. learning to learn and rapid skills development.

**Placement** Research will be strengthened by a substantive, enriching placement, with mentorship by partners to help students develop different career pathways, e.g. industry, public sector, DRR practice through global organisations/NGOs, and academia. 
...
Apply for a PhD through i-Risk here:
